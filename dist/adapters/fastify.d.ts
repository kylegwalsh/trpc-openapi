...
export declare function fastifyTRPCOpenApiPlugin<TRouter extends OpenApiRouter>(fastify: FastifyInstance, opts: CreateOpenApiFastifyPluginOptions<TRouter>, done: (err?: Error) => void): void;
