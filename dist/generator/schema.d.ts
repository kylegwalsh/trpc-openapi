...
export declare const getParameterObjects: (schema: unknown, pathParameters: string[], inType: "all" | "path" | "query", example: Record<string, any> | undefined, arrayParameterName?: string) => OpenAPIV3.ParameterObject[] | undefined;
