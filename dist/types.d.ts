...
export type CreateOpenApiAwsLambdaHandlerOptions<TRouter extends OpenApiRouter, TEvent extends APIGatewayProxyEvent | APIGatewayProxyEventV2> = Pick<AWSLambdaOptions<TRouter, TEvent>, 'router' | 'createContext' | 'responseMeta' | 'onError'>;
...
export type OpenApiRouter<TMeta = TRPCMeta, TRoot extends AnyRootTypes = CreateRootTypes<{
    ctx: any;
    meta: OpenApiMeta<TMeta>;
    errorShape: any;
    transformer: any;
}>, TDef extends RouterRecord = OpenApiProcedureRecord<TMeta>> = Router<TRoot, TDef>;
